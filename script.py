# First, let me create the main Streamlit application
streamlit_app_code = '''
...
with open("ocr_validation_app.py", "w", encoding="utf-8") as f:
    f.write(streamlit_app_code)

print("✅ Streamlit app created successfully!")
print("\nFiles created:")
print("- ocr_validation_app.py (Main Streamlit application)")